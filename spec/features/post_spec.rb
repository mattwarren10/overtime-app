...
describe 'navigate' do
  ...
  let(:post) do
    Post.create(date: Date.today, rationale: "asdf", user_id: user.id, overtime_request: 3.2)
  end
  before do
  ...
  describe 'delete' do    
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: 'asdf', user_id: delete_user.id, overtime_request: 3.2)
      visit posts_path
